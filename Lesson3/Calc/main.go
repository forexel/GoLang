...
if op == "!"{
	...
	} else if op == "*"{ //если оператор умножить
		result = a*b
	fmt.Println("a*b=", result) //выводим результат умножения
	} else if op == "/"{ //если оператор делить
		if b == 0{
